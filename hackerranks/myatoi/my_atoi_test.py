...
class TestLongestSubstring(unittest.TestCase):
    ...
    def test_normal_positive_int(self):
        s = "1234"
        self.assertEqual(1234, my_atoi.my_atoi(s))
    ...
    def test_valid_zero_strings(self):
        s = "0"
        self.assertEqual(0, my_atoi.my_atoi(s))
    ...
    def test_32_bit_signed_bounds(self):
        ...
        self.assertEqual(2147483647, my_atoi.my_atoi(s))

        s = "-2147483649"  # -2**31-1 = lower_bound - 1 -> should return -2**31
        self.assertEqual(-2147483648, my_atoi.my_atoi(s))
